...
languages = {
    "ru": {
        ...
        "get_signal": "⚜️Запустить ассистента⚜️",
        ...
        "register_info": f"""<b>Для активации бота нужно зарегистрировать новый аккаунт через бота!</b>

<b>✦ При регистрации обязательно вводите промокод - {PROMO}</b>

📱Номер телефона можете использовать любой(несуществующий),а вот почту заведите новую на себя!

<b>● После завершения регистрации, Вам автоматически придет уведомление в бота.</b>
""",
       "instruction_info": """<b>🔥 Твой ИИ-Ассистент: Эволюция побед!</b>

Теперь это настоящий аналитический центр для <b>Rocket Queen</b> и <b>Lucky Jet</b> 🚀

📸 <b>Умный анализ по скриншоту</b>
Больше не нужно гадать! Просто <b>сделай скриншот истории раундов</b> и отправь боту. Нейросеть мгновенно проанализирует паттерны и выдаст лучшую стратегию под текущую ситуацию.

🛡 <b>Непробиваемая математика</b>
Мы обновили алгоритмы! Бот рассчитывает сумму ставки так, чтобы ты <b>выходил в плюс даже после 4-х минусов подряд</b>. Система работает с любыми коэффициентами и бережет твой депозит.

🧠 <b>Личный AI-Советник</b>
Нужен совет по управлению банком или поддержка? Общайся с умным помощником прямо в чате! Он поможет избежать ошибок, научит грамотному риск-менеджменту и настроит на победу.

🎮 <b>NEW! Киберспорт</b>
ИИ теперь анализирует статистику команд и игроков, определяя будущих победителей раундов с высокой точностью.

⚡️ <b>Запускай ассистента, доверься технологиям и забирай своё!</b>
""",
