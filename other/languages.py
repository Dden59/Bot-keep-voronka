...
""",
        "instruction_info": """<b>🔥 Как это работает?

1. Ставка рассчитывается за тебя! Бот автоматически определяет оптимальную сумму ставки, чтобы даже после 3 проигрышей и 1 выигрыша ты вернул свой банк. Просто доверься математике!</b>

2. Коэффициент 1.5x — нажимай «Выиграл», и бот добавит выигрыш в банк. Проиграл? Банк уменьшится, но система тут же скорректирует следующую ставку для защиты твоих средств. 

3. <b>Шкала паники — твой индикатор</b> <a href='{ref_url}'>РИСКА</a> 
- Проиграл? Шкала растет, напоминая: «Соблюдай стратегию!»
<b>- Выиграл? Шкала снижается, давая понять: «Все под контролем!»</b>

💡 Совет
🟢 Всегда жми «Выиграл»/«Проиграл» после раунда — это важно для точных расчетов.  
🟢 Не пытайся «отыграться» вручную. Доверься алгоритму — он вернет банк даже после серии неудач.  
⏱️ Время действовать!
Запускай своего ассистента, ставь с умом и покоряй Rocket Queen без стресса. Твой банк — под защитой! 🚀💎
""",
